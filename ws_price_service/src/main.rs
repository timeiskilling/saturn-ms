...
// use crate::jupiter_impl::jupiter_trader::JupiterTrader;
...
//     let url = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=false&category=solana-ecosystem";
...
// pub async fn run_binance_ws_listener(state: Arc<JupiterTrader>) {
//     loop {
...
// pub async fn handle_websocket(mut socket: WebSocket, state: Arc<JupiterTrader>) {
